...
public class Main extends Application {
    ...
    /** Classic campaign level package. */
    public static List<Level> CLASSIC_CAMPAIGN;
    /** Extended campaign level package. */
    public static List<Level> EXTENDED_CAMPAIGN;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        if (thisClassFile.matches("(.+).jar")) builder.append("../");
        builder.append("../../resources/");
        RESOURCES_ROOT = builder.toString();

        // Loading campaigns
        CLASSIC_CAMPAIGN = XMLLevelLoader.loadLevelPack(Main.getResource("levels/classic.xml"));
        EXTENDED_CAMPAIGN = XMLLevelLoader.loadLevelPack(Main.getResource("levels/extended.xml"));

        // Loading product version
        try {
            PRODUCT_VERSION = "v. " + FileIO.load(Main.getResource(".build_version"));
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void changeScene(String sceneIdentifier) {
        changeScene(sceneIdentifier, "", fxController -> fxController);
    }
    ...
    public static void changeScene(String sceneIdentifier, String windowTitle) {
        changeScene(sceneIdentifier, windowTitle, fxController -> fxController);
    }
     ...
     */
    public static void changeScene(String sceneIdentifier, String windowTitle,
                                   Function<FXController, FXController> setupFunc) {
        try {
            ...
            if (sceneContent.controller != null) {
                ...
                sceneContent.controller = setupFunc.apply(sceneContent.controller.clone());
     ...
     *
     * @param sceneIdentifier name of {@link .fxml} file in which scene is (includes {@code .fxml}).
